...
(function ($) {
  Drupal.color = {
    ...
    callback: function(context, settings, form, farb, height, width) {
      ...
      $('#preview #preview-content a', form).css('color', $('#palette input[name="palette[base]"]', form).val());
      $('#preview #preview-content h1', form).css('color', $('#palette input[name="palette[link]"]', form).val());
